...
public class torneosServlet extends HttpServlet {
    ...
    String carpeta = "torneos"; // carpeta donde estan las vistas
    String id_tabla = "id_torneo"; // el name del input relacionado con el id de la tabla
    ...
    protected void nuevo(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean = new torneosBean(0);
            dao = new torneosDao(con);
            List<torneosBean> lista = dao.consultar(bean);
    ...
    protected void consultarId(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao = new torneosDao(con);
            // se ejecutan las acciones requeridas a los dao
            List<torneosBean> lista = dao.consultarId(bean);
            // se inician los bean
            lb = new lugaresBean(0);
            // se inicia la conexion a la base de datos
            con = new conexion();
