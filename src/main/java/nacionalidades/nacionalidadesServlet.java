 ...
 */
public class nacionalidadesServlet extends HttpServlet {
    ...
    nacionalidadesDao dao;
    nacionalidadesBean bean;
    // atributos de uso complementario
    paises.paisesDao pd;
    paises.paisesBean pb;
    // variables de reusabilidad
    String carpeta = "nacionalidades"; // carpeta donde estan las vistas
    String id_tabla = "id_nacionalidad"; // el name del input relacionado con el id de la tabla
    ...
    protected void consultarId(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao = new nacionalidadesDao(con);
            // se ejecutan las acciones requeridas a los dao
            List<nacionalidadesBean> lista = dao.consultarId(bean);
           // se inician los bean
            pb = new paisesBean(0);
            // se inicia la conexion a la base de datos
            con = new conexion();
