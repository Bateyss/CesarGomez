...
public class equiposServlet extends HttpServlet {
    ...
    String carpeta = "equipos"; // carpeta donde estan las vistas
    String id_tabla = "id_equipo"; // el name del input relacionado con el id de la tabla
    ...
    protected void nuevo(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean = new equiposBean(0);
            dao = new equiposDao(con);
            List<equiposBean> lista = dao.consultar(bean);
    ...
    protected void insertar(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean.setId_equipo(id);
            bean.setGenero(genero);
            bean.setId_jugador1(id_jugador1);
            bean.setId_jugador2(id_jugador2);
            // se inicia la conexion a la base de datos
            con = new conexion();
            // se inician los dao
            dao = new equiposDao(con);
    ...
    protected void consultarId(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao = new equiposDao(con);
            // se ejecutan las acciones requeridas a los dao
            List<equiposBean> lista = dao.consultarId(bean);
            // se inician los bean
             // se inician los bean
            jb = new jugadoresBean(0);
            // se inicia la conexion a la base de datos
