...
public class arbitrosServlet extends HttpServlet {
    ...
    String carpeta = "arbitros"; // carpeta donde estan las vistas
    String id_tabla = "id_arbitro"; // el name del input relacionado con el id de la tabla
