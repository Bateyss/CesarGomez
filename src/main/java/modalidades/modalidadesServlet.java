...
public class modalidadesServlet extends HttpServlet {
    ...
    modalidadesDao dao;
    modalidadesBean bean;
    // atributos de uso complementario
    paises.paisesDao pd;
    paises.paisesBean pb;
    // variables de reusabilidad
    String carpeta = "modalidades"; // carpeta donde estan las vistas
    String id_tabla = "id_modalidad"; // el name del input relacionado con el id de la tabla
    ...
    protected void nuevo(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            bean = new modalidadesBean(0);
            dao = new modalidadesDao(con);
            List<modalidadesBean> lista = dao.consultar(bean);
    ...
    protected void consultarId(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao = new modalidadesDao(con);
            // se ejecutan las acciones requeridas a los dao
            List<modalidadesBean> lista = dao.consultarId(bean);
           // se inician los bean
            pb = new paisesBean(0);
            // se inicia la conexion a la base de datos
            con = new conexion();
