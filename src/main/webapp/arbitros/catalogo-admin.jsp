                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-info">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="arbitros?action=actualizar&id_arbitro=${bean.getId_arbitro()}">
                                                <div class="form-group">
                                                    <label >
                                                        Nombre de Arbitro
                                                    </label>
                                                    <input style="" value="${bean.getArbitro()}" name="arbitro" class="form-control"  type="text" required="true" />
                                                </div>
                                                <div class="form-group">
                                                    <label >
                                                        Nacionalidad
                                                    </label>
                                                    <select it name="id_nacionalidad" required="true" class="form-control">
                            ...
                            <div class="modal fade " id="modal-container-eliminar-<%= x%>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-danger">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="arbitros?action=eliminar&id_arbitro=${bean.getId_arbitro()}">
                                                <div class="form-group">
                                                    <label >
