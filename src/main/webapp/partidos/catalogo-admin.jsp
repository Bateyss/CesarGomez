                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-info">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="lugares?action=actualizar&id_lugar=${bean.getId_lugar()}">
                                                div class="form-group">
                                            <label >
                                                Nombre de Lugar
                                            </label>
                                                <input value="${bean.getLugar()}" name="lugar" type="text" required="true">
                                        </div>
                                        <div class="form-group">
                                            <label >
                                                Pais de lugar
                            ...
                            <div class="modal fade " id="modal-container-eliminar-<%= x%>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-danger">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="lugares?action=eliminar&id_lugar=${bean.getId_lugar()}">
                                                <div class="form-group">
                                                    <label >
