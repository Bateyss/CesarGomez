                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content bg-info">
                                ...
                                <div class="modal-body">
                                    <form role="form" method="post" action="partidos?action=insertar">
                                        <div class="form-group">
                                            <label >
                                                Nombre de Lugar
                                            </label>
                                            <input name="lugar" type="text" required="true">
                                        </div>
                                        <div class="form-group">
                                            <label >
                                                Nombre del Torneo
                                            ...
                                            <select name="id_sesion" required="true" class="form-control">
                                                ...
                                                <c:forEach items="${sesiones}" var="ses">
                                                    <option value="${ses.getId_sesion()}">${ses.getDescripcion()}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select name="id_modalidad" required="true" class="form-control">
                                                <option selected="true" value="">Seleccione una opcion..</option>
                                                <c:forEach items="${sesiones}" var="ses">
                                                    <option value="${ses.getId_sesion()}">${ses.getDescripcion()}</option>
                                                </c:forEach>
