                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-info">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="paises?action=actualizar&id_pais=${bean.getId_pais()}">
                                                <div class="form-group">
                                                    <label >
                                                        Nombre de Pais
                                                    </label>
                                                    <input value="${bean.getPais()}" name="pais" type="text" required="true">
                                                </div>
                            ...
                            <div class="modal fade " id="modal-container-eliminar-<%= x%>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-danger">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="paises?action=eliminar&id_pais=${bean.getId_pais()}">
                                                <div class="form-group">
                                                    <label >
