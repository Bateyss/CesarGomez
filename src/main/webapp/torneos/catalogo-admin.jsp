                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-info">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="nacionalidades?action=actualizar&id_nacionalidad=${bean.getId_nacionalidad()}">
                                                div class="form-group">
                                            <label >
                                                Nombre de Lugar
                                            </label>
                                                <input value="${bean.getNacionalidad()}" name="nacionalidad" type="text" required="true">
                                        </div>
                                        <div class="form-group">
                                            <label >
                                                Pais de lugar
                                            ...
                                            <select name="id_pais" required="true" class="form-control">
                                                <option selected="true" value="">--${bean.getPais()}--</option>
                            ...
                            <div class="modal fade " id="modal-container-eliminar-<%= x%>" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content bg-danger">
                                        ...
                                        <div class="modal-body">
                                            <form role="form" method="post" action="nacionalidades?action=eliminar&id_nacionalidad=${bean.getId_nacionalidad()}">
                                                <div class="form-group">
                                                    <label >
